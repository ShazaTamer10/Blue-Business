        ...
        <div class="row">
            <div class="col-lg-8">
                <div class="header-text">
                    {{-- <h3 class="typer-title wow fadeInUp" data-wow-delay="0.2s">We are Blue Business</h3> --}}
                    <h1 class="title wow fadeInUp" data-wow-delay="0.3s">{{$hero->title?? 'No Title Available'}}</h1>
