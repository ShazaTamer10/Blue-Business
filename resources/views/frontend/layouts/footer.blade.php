    ...
    <div class="container">
        <div class="row footer-widgets">
            ...
            <div class="col-md-4 col-lg-3 widget">
                ...
                <ul>
                    <li>Mogamaa Elmahakem, Mansoura, Egypt.</li>
                    <li><a href="#">+1347-430-9510</a></li>
                    <li><a href="#">bluebusiness@gmail.com</a></li>
                </ul>
            </div>
            <div class="col-md-4 col-lg-3 widget">
    ...
    <div class="footer-bottom">
        <div class="container">
            <div class="row">
                <div class="col-12">
                    <div class="copyright">
                        <p>Copyright<span> Blue Business</span>.  All Rights Reserved.</p>
                        <p>Powered by Blue Business &nbsp; | &nbsp; </p>
                    </div>
                </div>
            </div>
        </div>
