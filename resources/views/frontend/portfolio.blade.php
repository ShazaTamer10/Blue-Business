            ...
            <div data-wow-delay="0.4s" class="col-md-6 col-lg-4 filter-item interface">
                <div class="single-portfolio">
                    ...
                    <div class="portfolio-content">
                        ...
                        <h4 class="title"><a href="portfolio-details.php">Fitzgerald Stanton</a></h4>
                        <div class="desc">
                            <p>Lorem ipsum dolor sit amet consectetur adipisicing elit.</p>
                        </div>
                    </div>
            ...
            <div data-wow-delay="0.5s" class="col-md-6 col-lg-4 filter-item branding">
                <div class="single-portfolio">
                    ...
                    <div class="portfolio-content">
                        ...
                        <h4 class="title"><a href="portfolio-details.php">Ines Campbell</a></h4>
                        <div class="desc">
                            <p>Lorem ipsum dolor sit amet consectetur adipisicing elit.</p>
                        </div>
                    </div>
            ...
            <div data-wow-delay="0.3s" class="col-md-6 col-lg-4 filter-item interface experience">
                <div class="single-portfolio">
                    ...
                    <div class="portfolio-content">
                        ...
                        <h4 class="title"><a href="portfolio-details.php">Wendi Michael</a></h4>
                        <div class="desc">
                            <p>Lorem ipsum dolor sit amet consectetur adipisicing elit.</p>
                        </div>
                    </div>
            ...
            <div data-wow-delay="0.4s" class="col-md-6 col-lg-4 filter-item branding development experience">
                <div class="single-portfolio">
                    ...
                    <div class="portfolio-content">
                        ...
                        <h4 class="title"><a href="portfolio-details.php">Guerrero Woodard</a></h4>
                        <div class="desc">
                            <p>Lorem ipsum dolor sit amet consectetur adipisicing elit.</p>
                        </div>
                    </div>
