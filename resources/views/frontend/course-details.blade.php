            ...
            <div class="col-sm-12">
                ...
                <div class="blog-meta">
                    ...
                    <div class="single-meta">
                        ...
                        <h4 class="meta-value"><a href="javascript::void(0)">{{$course->getCategory->name}}</a></h4>
                    </div>
                </div>
                <figure class="image-block">
                    <img class="img-fix" src="{{asset($course->image)}}" alt="">
                </figure>
                ...
                <div class="single-navigation">
                    ...
                    @if ($previousPost)
                    <a href="{{route('show.course',$previousPost->id)}}" class="nav-link"><span class="icon"><i
                    ...
                    <a href="{{route('show.course',$nextPost->id)}}" class="nav-link"><span class="text">{{$nextPost->title}}</span><span
